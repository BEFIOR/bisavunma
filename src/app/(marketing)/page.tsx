        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Savunma sektöründe uzmanlığımız ve yenilikçi yaklaşımımızla fark
              yaratıyoruz
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-lg bg-gray-50 hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                En son teknolojileri kullanarak güvenilir ve etkili savunma
                çözümleri sunuyoruz.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                BİSAVUNMA, savunma teknolojileri alanında uzmanlaşmış bir
                şirkettir. Müşterilerimize en son teknolojileri kullanarak
                güvenilir ve etkili çözümler sunuyoruz.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                Deneyimli ekibimiz ve yenilikçi yaklaşımımızla, savunma
                sektöründe güvenilir bir partner olarak hizmet veriyoruz.
              </p>
