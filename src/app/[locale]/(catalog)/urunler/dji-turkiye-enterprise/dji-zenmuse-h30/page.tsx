...
export const metadata = {
  title:
    "DJI Zenmuse H30 | Flagship All-Weather Multi-Sensor Payload | Bisavunma",
  description:
    "DJI Zenmuse H30 flagship all-weather multi-sensor payload. 40MP zoom kamera, 34× optik zoom, 400× dijital zoom, 3000m lazer mesafe ölçer, NIR aydınlatma. Gün ve gece operasyonları için ideal.",
};

export default function DJIZenmuseH30Page() {
  return (
            ...
            <div className="space-y-6">
              <HeroAnimation direction="fade" delay={0.2}>
                <div className="inline-flex items-center gap-2 text-sm text-gray-400">
                  ...
                  <span>/</span>
                  <span className="text-white">DJI Zenmuse H30</span>
                </div>
              </HeroAnimation>
              ...
              <HeroAnimation direction="up" delay={0.4}>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white">
                  ...
                  <br />
                  <span className="text-sky-400">DJI Zenmuse H30</span>
                </h1>
              </HeroAnimation>
              ...
              <HeroAnimation direction="up" delay={0.8}>
                <p className="text-lg text-gray-300 leading-relaxed">
                  DJI Zenmuse H30, dört ana modülü tek bir gimbalda birleştirir:
                  geniş açılı kamera, zoom kamera, lazer mesafe ölçer ve NIR
                  yardımcı ışık. Gün ve gece görüş sınırlarını aşarak
                  operasyonel standartları yeniden tanımlar.
                </p>
              </HeroAnimation>
              ...
              >
                <StaggerItem>
                  <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-lg p-4">
                    <div className="text-2xl font-bold text-sky-400">40MP</div>
                    <div className="text-sm text-gray-400">Zoom Kamera</div>
                  </div>
                </StaggerItem>
                <StaggerItem>
                  <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-lg p-4">
                    <div className="text-2xl font-bold text-sky-400">34×</div>
                    <div className="text-sm text-gray-400">Optik Zoom</div>
                  </div>
                </StaggerItem>
                <StaggerItem>
                  <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-lg p-4">
                    <div className="text-2xl font-bold text-sky-400">400×</div>
                    <div className="text-sm text-gray-400">Dijital Zoom</div>
                  </div>
                </StaggerItem>
                <StaggerItem>
                  <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-lg p-4">
                    <div className="text-2xl font-bold text-sky-400">3000m</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li>• DJI Zenmuse H30 kamera sistemi</li>
                <li>• Görsel kamera</li>
                <li>• 3-axis gimbal</li>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <ScrollAnimation direction="up">
            <h2 className="text-3xl font-bold text-white mb-6">
              DJI Zenmuse H30 ile Operasyonlarınızı Güçlendirin
            </h2>
            <p className="text-lg text-gray-300 mb-8">
              Yüksek kaliteli görsel görüntüleme teknolojisi ile profesyonel
              çözümler için hemen iletişime geçin.
            </p>
