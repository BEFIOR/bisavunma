...
export const metadata = {
  title: "DJI Zenmuse L2 | LiDAR Tarama Sistemi | Bisavunma",
  description:
    "DJI Zenmuse L2 LiDAR tarama sistemi. 3D haritalama, yüksek hassasiyet, IP54 koruma. Haritalama ve ölçüm operasyonları için ideal.",
};

export default function DJIZenmuseL2Page() {
  return (
            ...
            <div className="space-y-6">
              <HeroAnimation direction="fade" delay={0.2}>
                <div className="inline-flex items-center gap-2 text-sm text-gray-400">
                  ...
                  <span>/</span>
                  <span className="text-white">DJI Zenmuse L2</span>
                </div>
              </HeroAnimation>
              ...
              <HeroAnimation direction="up" delay={0.4}>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white">
                  ...
                  <br />
                  <span className="text-green-400">DJI Zenmuse L2</span>
                </h1>
              </HeroAnimation>
              ...
              <HeroAnimation direction="up" delay={0.8}>
                <p className="text-lg text-gray-300 leading-relaxed">
                  DJI Zenmuse L2, gelişmiş LiDAR teknolojisi ile 3D haritalama
                  ve ölçüm çözümleri sunar. Yüksek hassasiyet, geniş tarama
                  alanı ve profesyonel veri işleme ile haritalama operasyonları
                  için ideal.
                </p>
              </HeroAnimation>
              ...
              >
                <StaggerItem>
                  <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-lg p-4">
                    <div className="text-2xl font-bold text-green-400">3D</div>
                    <div className="text-sm text-gray-400">Haritalama</div>
                  </div>
                </StaggerItem>
                <StaggerItem>
                  <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-lg p-4">
                    ...
                    <div className="text-sm text-gray-400">Tarama</div>
                  </div>
                </StaggerItem>
              </HeroStaggerContainer>
            ...
            <HeroScaleAnimation delay={1.0}>
              <div className="relative">
                ...
                <div className="relative bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-2xl p-8">
                  <Image
                    src="/products/dji-enterprise/dji-zenmuse-l2.webp"
                    alt="DJI Zenmuse L2"
                    width={600}
                    height={400}
        ...
        <div className="max-w-7xl mx-auto">
          <ScrollAnimation direction="up" className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">
              Gelişmiş LiDAR teknolojisi ile donatılmış
            </p>
          </ScrollAnimation>
      ...
      <section className="py-20 px-4 border-t border-neutral-900">
        <div className="max-w-7xl mx-auto">
          <ScrollAnimation direction="up" className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">
              LiDAR teknolojisi ile çeşitli haritalama ve ölçüm operasyonlarında
              kullanım
            </p>
          </ScrollAnimation>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <ScrollAnimation direction="up" delay={0.1}>
              <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 text-center">
                ...
                <p className="text-gray-400 text-sm">
                  Yüksek hassasiyetli 3D harita oluşturma
                </p>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation direction="up" delay={0.2}>
              <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 text-center">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Ölçüm</h3>
                <p className="text-gray-400 text-sm">
                  Hassas mesafe ve yükseklik ölçümleri
                </p>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation direction="up" delay={0.3}>
              <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 text-center">
                ...
                <p className="text-gray-400 text-sm">
                  İnşaat sahalarında hacim ve alan hesaplama
                </p>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation direction="up" delay={0.4}>
              <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 text-center">
                ...
                <p className="text-gray-400 text-sm">
                  Ağaç yükseklik ve yoğunluk analizi
                </p>
              </div>
            </ScrollAnimation>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li>• DJI Zenmuse L2 LiDAR sistemi</li>
                <li>• LiDAR sensör</li>
                <li>• 3-axis gimbal</li>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <ScrollAnimation direction="up">
            <h2 className="text-3xl font-bold text-white mb-6">
              DJI Zenmuse L2 ile Haritalama Operasyonlarınızı Güçlendirin
            </h2>
            <p className="text-lg text-gray-300 mb-8">
              Gelişmiş LiDAR teknolojisi ile profesyonel haritalama çözümleri
