...
export const metadata = {
  title:
    "VEGA Ultra Uzun Menzilli Çoklu Sensörlü PTZ Kamera Sistemi | Bisavunma",
  description:
    "VEGA ultra uzun menzilli çoklu sensörlü EO-IR PTZ kamera sistemi. En uzun menzilli görünür kamera, gelişmiş soğutmalı/soğutmasız termal kameralar, ZLID aydınlatma, LRF lazer mesafe ölçer ve jiroskop stabilizasyon.",
};
            ...
            <HeroStaggerContainer className="space-y-8">
              ...
              <HeroAnimation direction="up" delay={0.6}>
                <p className="text-lg text-gray-300 leading-relaxed">
                  VEGA tamamen özelleştirilebilir çoklu sensörlü EO-IR PTZ
                  kamera sistemi. En uzun menzilli görünür gündüz/gece zoom
                  kamerası ve en gelişmiş soğutmalı veya soğutmasız termal
                  kızılötesi kameraları ile donatılmış. Opsiyonel ZLID™ uzun
                  menzilli NIR aydınlatma, LRF yüksek hassasiyetli mesafe ölçer,
                  jiroskop stabilizasyon ve daha fazlası ile yapılandırılabilir.
                </p>
              </HeroAnimation>
            ...
            <HeroAnimation direction="right" delay={1.0}>
              <div className="relative h-[400px] lg:h-[500px] flex items-center justify-center">
                ...
                <div className="relative z-10 w-full h-full flex items-center justify-center p-8">
                  <Image
                    src="/products/elektro-optik/vega.png"
                    alt="VEGA Ultra Uzun Menzilli PTZ Kamera Sistemi"
                    width={600}
                    height={400}
        ...
        <div className="max-w-7xl mx-auto">
          <ScrollAnimation direction="up" className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              VEGA ile ultra uzun menzilli çoklu sensörlü PTZ teknolojisi
            </p>
          </ScrollAnimation>
      ...
      <section className="py-20 px-4 bg-neutral-950 border-t border-neutral-900">
        <div className="max-w-7xl mx-auto">
          <ScrollAnimation direction="up" className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              VEGA için mevcut kamera konfigürasyonları
            </p>
          </ScrollAnimation>
            ...
            <ScrollAnimation direction="up">
              <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="border-l-2 border-sky-400 pl-3">
                    <h4 className="text-white font-medium">4M-95X</h4>
                    <p className="text-sm text-gray-400">
                      10–955mm 95X Long-Range Visible/NIR 4MP Camera
                    </p>
                    <p className="text-xs text-gray-500">
                      4MP sensor, high resolution
                    </p>
                  </div>
                  <div className="border-l-2 border-sky-400 pl-3">
                    <h4 className="text-white font-medium">2M-88X</h4>
                    <p className="text-sm text-gray-400">
                      6.2–550mm 88X Long-Range Visible/NIR 2MP Camera
                    </p>
                    <p className="text-xs text-gray-500">
                      2MP sensor, HD resolution
                    </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <ScrollAnimation direction="left">
              <div className="relative h-[400px] rounded-xl overflow-hidden bg-neutral-800 flex items-center justify-center">
                ...
                <Image
                  src="/products/elektro-optik/vega-1.png"
                  alt="VEGA Teknik Özellikler"
                  width={600}
                  height={400}
      ...
      <section className="py-20 px-4 border-t border-neutral-900">
        <div className="max-w-7xl mx-auto">
          <ScrollAnimation direction="up" className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              VEGA ultra uzun menzilli çoklu sensörlü PTZ sistemi ile 24/7
        ...
        <div className="max-w-4xl mx-auto text-center">
          <ScrollAnimation direction="up">
            <h2 className="text-3xl font-bold text-white mb-6">
              VEGA Ultra Uzun Menzilli PTZ Sistemi
            </h2>
