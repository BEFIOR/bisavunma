          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                DJI Agras T40, yüksek kapasiteli ilaçlama ve gübreleme işlemleri
                için tasarlanmış, ileri teknolojili bir tarımsal drone
                çözümüdür. Çift rotor tasarımı, akıllı püskürtme sistemi ve
                hassas ölçüm sensörleri sayesinde geniş tarım arazilerinde
                verimliliği artırır.
              </p>
      ...
      <section className="py-20 px-4 border-t border-neutral-900">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-300 mb-12 text-center max-w-4xl mx-auto">
            ...
            Binoküler Görüş, Aktif Fazlı Radar ile üst düzeyde hassasiyet sunar.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-semibold text-white">Haritalama</h3>
              </div>
              <p className="text-gray-400">
            ...
            <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-semibold text-white">Püskürtme</h3>
              </div>
              <p className="text-gray-400">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-300">
                ...
                arazisi veya meyve bahçesi görüntüleriniz gerçek zamanlı olarak
                işlenebilir.
              </p>
      ...
      <section className="py-20 px-4 border-t border-neutral-900">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-300 mb-12 text-center max-w-4xl mx-auto">
            ...
            sağlamak için bir binoküler görüş sensörü sistemi ile birleştirildi
            ve bu sayede optimum güvenlik sunuyor. 50 m'ye kadar algılama
            mesafesi, düzgün ölçeklendirmeye, akıllı arazi takibine ve birden
            fazla engelin atlanmasına izin verir.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-300">
                ...
                yüksek parlaklıktaki geniş ekran, ayrıntılarıyla daha geniş bir
                görünüm sunar.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-lg p-4">
                  ...
                  <div className="text-sm text-gray-400">Fiziksel Düğmeler</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 border-t border-neutral-900">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-6">
            DJI Agras T40 ile Tarımsal Operasyonlarınızı Güçlendirin
          </h2>
          <p className="text-gray-300 mb-8">
            Koaksiyel ikiz rotor tasarımı, çift atomize püskürtme sistemi ve çok
            yönlü engel algılama ile geniş tarım arazilerinde maksimum
