          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                ...
                özelliklerine sahip lazer mesafe ölçer ile donatılmış Matrice 4T
                şimdi Bisavunma güvencesiyle sizlerle buluşuyor.
              </p>
              ...
              <p className="text-gray-300">
                ...
                operasyonları, önemli ölçüde geliştirilmiş algılama yetenekleri
                ile artık daha güvenli ve daha güvenilir hale geldi.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                ...
                <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-lg p-4">
                  <div className="text-2xl font-bold text-cyan-400">20MB/s</div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-20">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                Matrice 4 serisi, orta tele kamera ile donatılmıştır, bu da orta
                menzilli denetim görevleri için yeteneklerini genişletir.
              ...
              <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-2xl p-8 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-20">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                ...
                sayesinde, eve dönüş noktası güncellenebilir ve 15 saniye içinde
                hızlı bir kalkış yapılabilir.
              </p>
              <p className="text-gray-300">
                GNSS sinyalleri olmasa bile, eve dönüş sürecini tamamlayabilir,
                böylece şehir ortamlarında yaygın olan sinyal engelleri ve
                parazitleri etkili bir şekilde aşabilir.
              </p>
              <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-2xl p-8 max-w-4xl mx-auto">
                <div className="aspect-video bg-neutral-800 rounded-xl flex items-center justify-center mb-4">
                  <video
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-lg p-4">
                  ...
                  <div className="text-xl font-bold text-white">15 saniye</div>
                </div>
                <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-lg p-4">
                  <Target className="w-8 h-8 text-cyan-400 mb-2" />
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                ...
                yükleyebilir. Bu, engel kaçınma için otomatik rota planlamasını
                mümkün kılar, gece uçuşu veya dağlık bölgeler gibi senaryoları
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-2xl p-8"></div>
              <div className="bg-neutral-900/50 backdrop-blur border border-neutral-800 rounded-2xl p-8">
          ...
          <div className="aspect-video bg-neutral-800 rounded-xl flex items-center justify-center mt-12">
            <video
      ...
      <section className="py-20 px-4 border-t border-neutral-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            ...
            endüstrilerde yeni bir dönem başlıyor. Gelişmiş algılama yetenekleri
            ile güvenli ve güvenilir operasyonlar.
          </p>
