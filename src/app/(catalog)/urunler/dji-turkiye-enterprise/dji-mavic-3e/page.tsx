            ...
            <div className="space-y-6">
              ...
              <HeroAnimation direction="up" delay={0.4}>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white">
                  DJI Mavic 3E
                  <span className="block text-lg text-blue-400 mt-2">
              ...
              <HeroAnimation direction="up" delay={1.0}>
                <p className="text-gray-300">
                  İş operasyonlarınızı optimize etmek, güvenilir veri toplamak
                  ve çevresel farkındalığı artırmak istiyorsanız, DJI Mavic 3
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <ScrollAnimation direction="up" delay={0.2}>
                <p className="text-gray-300">
                  DJI Mavic 3E, kompakt tasarımı ile her yere kolayca
            ...
            <div className="space-y-6">
              ...
              <ScrollAnimation direction="up" delay={0.2}>
                <p className="text-gray-300">
                  ...
                  Yakınlaştırmalı Kamera ile donatılmıştır. Ticari
                  operasyonlarda yüksek hassasiyet sunar.
                </p>
              </ScrollAnimation>
            </div>
