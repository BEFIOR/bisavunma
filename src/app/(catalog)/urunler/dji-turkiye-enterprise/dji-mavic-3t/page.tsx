            ...
            <div className="space-y-6">
              ...
              <HeroAnimation direction="up" delay={0.4}>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white">
                  DJI Mavic 3T
                  <span className="block text-lg text-sky-400 mt-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <ScrollAnimation direction="up" delay={0.2}>
                <p className="text-gray-300">
                  DJI Mavic 3T, kompakt tasarımı ile her yere kolayca
                  taşınabilir. Katlanabilir yapısı sayesinde operasyonel
                  esneklik sağlar ve hızlı deployment için ideal boyutlarda
                  tasarlanmıştır.
                </p>
              </ScrollAnimation>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <ScrollAnimation direction="up" delay={0.2}>
                <p className="text-gray-300">
                  DJI Mavic 3 T sahip olduğu termal kamera, 640 × 512
                  çözünürlüğe sahiptir. Hızlı kararlar almanıza ve hedeflerinizi
                  bulmanıza yardımcı olmak için nokta ve alan sıcaklık ölçümü,
                  yüksek sıcaklık uyarıları, izotermleri ve renk paletlerini
                  destekler.
                </p>
              </ScrollAnimation>
          ...
          >
            ...
            <StaggerItem>
              <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6">
                ...
                <p className="text-sm text-gray-400">
                  Gelişmiş Pilot Yardım Sistemleri, engellerin etrafından
                  otomatik olarak yeniden yönlendirme sağlar.
                </p>
              </div>
            </StaggerItem>
          ...
          >
            <StaggerItem>
              <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6">
                ...
                <p className="text-sm text-gray-400">
                  Gerçekçi 3D modeller, üç farklı çözünürlükte oluşturulabilir.
                  Su yüzeyleri, yapay zeka teknolojisi kullanılarak otomatik
            ...
            <StaggerItem>
              <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6">
                ...
                <p className="text-sm text-gray-400">
                  ...
                  yakalanan nokta bulutu verilerinin yüksek doğrulukta
                  işlenmesini sağlar.
                </p>
              </div>
            </StaggerItem>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <ScrollAnimation direction="up" delay={0.2}>
            <p className="text-gray-300 mb-8">
              ...
              operasyonlarınızı optimize edin. Uzman ekibimiz size en uygun
