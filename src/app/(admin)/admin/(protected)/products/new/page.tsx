    ...
    <div className="max-w-2xl">
      ...
      <form action={createAction} className="space-y-4">
        ...
        <div>
          ...
          <select
            name="categoryId"
            className="w-full rounded-lg bg-gray-900 border border-gray-800 px-3 py-2 text-gray-100"
          >
        ...
        <div className="flex gap-2">
          <button className="rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white px-4 py-2">
            Kaydet
          </button>
        </div>
      </form>
